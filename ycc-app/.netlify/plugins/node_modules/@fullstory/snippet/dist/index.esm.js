function injectSnippetArgs(snippetSrc, _ref) {
  var host = _ref.host,
    script = _ref.script,
  ...
  return snippetSrc.replace(/\$FS_HOST\$/g, q(host)).replace(/\$FS_SCRIPT\$/g, q(script)).replace(/\$FS_NAMESPACE\$/g, q(namespace)).replace(/\$FS_ORG_ID\$/g, q(orgId));
}

// @ts-nocheck
// Code generated by snippet-cli. DO NOT EDIT.
// Please see snippet-cli/README.md for how to update this file.
...
var mockSnippetV2_1 = "!function(m,n,e,t,l,o,g,y){var s,f,a=function(h){\nreturn!(h in m)||(m.console&&m.console.log&&m.console.log(\"FullStory namespace conflict. Please use a different namespace.\"),!1)}(l)\n;a&&(g=m[l]=function(){var b=function(b,d,j,i){i=i||2;var c,r=/Async$/;return r.test(b)&&(b=b.replace(r,\"\"),\n\"function\"==typeof Promise)?new Promise((function(c,r){h(b,d,j,c,r,i)})):h(b,d,j,c,c,i)};function h(h,d,j,i,c,r){\nreturn b._api?b._api(h,d,j,i,c,r):(b.q&&b.q.push([h,d,j,i,c,r]),null)}return b.q=[],b}(),function(){function b(){}function h(b,h,d){g(b,h,d,1)}\nfunction d(b,d,j){h(\"setProperties\",{type:b,properties:d},j)}function j(b,h){d(\"user\",b,h)}function i(b,h,d){j({uid:b},d),h&&j(h,d)}g.identify=i,\ng.setUserVars=j,g.identifyAccount=b,g.clearUserCookie=b,g.setVars=d,g.event=function(b,d,j){h(\"trackEvent\",{name:b,properties:d},j)},\ng.anonymize=function(){i(!1)},g.shutdown=function(){h(\"shutdown\")},g.restart=function(){h(\"restart\")},g.log=function(b,d){h(\"log\",{level:b,msg:d\n})},g.consent=function(b){h(\"setIdentity\",{consent:!arguments.length||b})}}(),s=\"fetch\",f=\"XMLHttpRequest\",g._w={},g._w[f]=m[f],g._w[s]=m[s],\nm[s]&&(m[s]=function(){return g._w[s].apply(this,arguments)}),g(\"init\",{env:{orgId:o,host:e,script:t}}),g._v=\"2.1.0\")\n}(window,document,$FS_HOST$,$FS_SCRIPT$,$FS_NAMESPACE$,$FS_ORG_ID$);";
var executeSnippet = function executeSnippet(_ref2) {
  var orgId = _ref2.orgId,
    _ref2$wnd = _ref2.wnd,
    wnd = _ref2$wnd === void 0 ? window : _ref2$wnd,
    _ref2$host = _ref2.host,
    host = _ref2$host === void 0 ? "fullstory.com" : _ref2$host,
    _ref2$namespace = _ref2.namespace,
    namespace = _ref2$namespace === void 0 ? "FS" : _ref2$namespace,
    _ref2$script = _ref2.script,
    script = _ref2$script === void 0 ? "edge.fullstory.com/s/fs.js" : _ref2$script;
  (function (win, doc, fsHost, fsScript, fsNamespace, fsOrgId, api, rejector) {
    var valid = function checkNamespaceV2_1(fsNamespace) {
      if (!(fsNamespace in win)) {
        return true;
      }
      if (win.console && win.console.log) {
        win.console.log("FullStory namespace conflict. Please use a different namespace.");
      }
      return false;
    }(fsNamespace);
    if (!valid) return;
    api = win[fsNamespace] = function createV2_1API() {
      var FS = function FS(action, options, source, apiVersion) {
        ...
        if (re.test(action)) {
          ...
          // Just return api as-is if promise is not available.
        }
        var _undefined;
    ...
    (function insertV2_1Script() {
      var tag = 'script';
      var script = doc.createElement(tag);
      script.async = true;
      script.crossOrigin = 'anonymous';
      script.src = 'https://' + fsScript + '?org=' + fsOrgId;
      script.setAttribute('data-fs-namespace', fsNamespace);
    ...
    api._v = "2.1.0";
  })(wnd, wnd.document, host, script, namespace, orgId);
};
var executeSnippetV2 = function executeSnippetV2() {
  var _ref3 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
    _ref3$wnd = _ref3.wnd,
    wnd = _ref3$wnd === void 0 ? window : _ref3$wnd,
    _ref3$injectedNamespa = _ref3.injectedNamespace,
    injectedNamespace = _ref3$injectedNamespa === void 0 ? wnd['_fs_namespace'] : _ref3$injectedNamespa,
    _ref3$injectedScript = _ref3.injectedScript,
    injectedScript = _ref3$injectedScript === void 0 ? wnd['_fs_script'] : _ref3$injectedScript;
...
var executeSnippetV1 = function executeSnippetV1() {
  var _ref4 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
    _ref4$wnd = _ref4.wnd,
    wnd = _ref4$wnd === void 0 ? window : _ref4$wnd,
    _ref4$injectedNamespa = _ref4.injectedNamespace,
    injectedNamespace = _ref4$injectedNamespa === void 0 ? wnd['_fs_namespace'] : _ref4$injectedNamespa;
...
var toV1String = function toV1String() {
  var _ref5 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
    _ref5$shouldInsertScr = _ref5.shouldInsertScript,
    shouldInsertScript = _ref5$shouldInsertScr === void 0 ? true : _ref5$shouldInsertScr,
    _ref5$globalVar = _ref5.globalVar,
    globalVar = _ref5$globalVar === void 0 ? 'window' : _ref5$globalVar,
    _ref5$globalNamespace = _ref5.globalNamespace,
    globalNamespace = _ref5$globalNamespace === void 0 ? "".concat(globalVar, "['_fs_namespace']") : _ref5$globalNamespace,
    _ref5$apiVersion = _ref5.apiVersion,
    apiVersion = _ref5$apiVersion === void 0 ? '1.3.0' : _ref5$apiVersion;
...
var initFSV2 = function initFSV2(_a) {
  var orgId = _a.orgId,
    _b = _a.namespace,
    namespace = _b === void 0 ? 'FS' : _b,
    _c = _a.host,
...
var generateSnippetText = function generateSnippetText(_a) {
  ...
  return injectSnippetArgs(SnippetSrcV2_1, {
    host: host,
    script: script,
    namespace: namespace,
    orgId: orgId
...
var generateSnippetTextV2 = function generateSnippetTextV2(_a) {
  var orgId = _a.orgId,
    _b = _a.namespace,
    namespace = _b === void 0 ? 'FS' : _b,
    _c = _a.host,
...
var mockSnippetSrc = mockSnippetV2_1;
var mockSnippetSrcV2 = mockSnippetV2;
var mockSnippetSrcV1 = mockSnippetV1;
export { SnippetSrc, SnippetSrcDelayed, SnippetSrcV1, SnippetSrcV2, generateSnippetText, generateSnippetTextV1, generateSnippetTextV2, initFS, initFSV1, initFSV2, injectSnippetArgs, mockSnippetSrc, mockSnippetSrcV1, mockSnippetSrcV2 };